...
echo "=== Selectel API Configuration ==="
echo ""
echo "This script will configure automatic server start/stop when connecting to VPN."
echo ""
echo "To get your API token:"
echo "1. Go to https://panel.selectel.com/"
...
echo "1. Go to your server in Selectel panel"
echo "2. Server ID is in the URL: .../servers/12345/..."
echo "   Or check server details page"
echo ""
